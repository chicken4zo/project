                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-5 mx-auto">
                                    ...
                                    <h5 class="mt-lg-0 mt-4 address"><i
                                            class="fas fa-map-marker-alt"></i>${product.address}</h5>
                                ...
                                <div class="col-12">
                                    ...
                                    <form>
                                        <div class="commentWrite_Wrap">
                                            ...
                                            <input type="hidden" name="writerId" id="id" value="${product.id}">
                                            <input type="text" name="commentId" id="commentId" value="${id}">
                                            <textarea placeholder="댓글을 남겨보세요" class="comment_inbox" rows="4"
                                                      name="content"
                                                      cols="140"></textarea>
                                            <input type="submit" value="등록" id="commentWriteBtn"> <!-- onclick 유효성체크 -->
