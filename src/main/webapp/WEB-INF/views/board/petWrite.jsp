...
<div id="body_wrap">
    <div class="wrapper">
        ...
        &lt;%&ndash;<form name="bbs" action="petWrite.board" method="POST" enctype="multipart/form-data">
            <div class="product-group">
                <section class="product-wrap">
                    <!--    <h2>글쓰기</h2>-->
                    <ul class="product-info">
                        ...
                        <li class="info-title idAddress">
                            <div class="info-detail">아이디</div>
                            <input type="text" name="id" placeholder="!!!아이디 불러오기" class="write-title">
                            &lt;%&ndash;<div class="info-detail">주소</div>
                            <input type="text" name="address" placeholder="!!!주소 불러오기" class="write-title">&ndash;%&gt;
                        </li>
