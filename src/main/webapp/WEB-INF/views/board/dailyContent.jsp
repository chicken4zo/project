                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <!--product details-->
                            <c:choose>
                                <c:when test="${not empty daily.fileName}">
                                    <div class="row">
                                        <!--image space-->
                                        <!-- Gallery -->
                                        <div id="js-gallery" class="gallery col-xl-5 col-lg-6 text-center">
                                            ...
                                            <div class="gallery__hero parent">
                                                ...
                                                <img class="slide w-100 border-radius-lg shadow-lg mx-auto"
                                                     src="assets/upload/${daily.fileName}">
                                            </div>
                                            <!--Gallery Hero-->
                                        ...
                                        <div class="col-lg-5 mx-auto">
                                            ...
                                            <ul class="view_icon">
                                                <li><i class="fas fa-eye"></i><span>${daily.hit}</span></li>
                                                <li><i class="far fa-calendar-alt"></i><span>${daily.writeDate}</span>
                                                </li>
                                            </ul>
                                            <div class="content">
                                                    ${daily.content}
                                ...
                                <c:otherwise>
                                    <div class="row">
                                        ...
                                        <div class="col-12" style="padding: 0px 32px">
                                            <div class="titleContainer">
                                                <h5 class="mb-0 mt-3">${daily.title}</h5>
                                            </div>
                                            <div class="idAddr">
                                                <h4 class="mt-lg-0 mt-4 id">${daily.id}</h4>
                                                <h5 class="mt-lg-0 mt-4 address"><i class="fas fa-map-marker-alt"></i>
                            ...
                            <div class="row mt-5">
                                <div class="col-12">
                                    <div class="ms-3 button_container">
                                        ...
                                        <c:if test="${daily.id eq id}">
                                            <button type="button" class="btn btn-warning btn-sm"
                                                    onclick="location.href='dailyModify.board?idx=${daily.idx}&id=${daily.id}'">
                                                <i class="fas fa-pen"></i>
                                                <span>수정</span>
                                            </button>
                                            <button type="button" class="btn btn-danger btn-sm"
                                                    onclick="location.href='dailyDelete.board?idx=${daily.idx}'">
                                                <i class="fas fa-trash-alt"></i>
                                                <span>삭제</span>
                                            </button>
                                        </c:if>
                                        <button type="button" class="btn btn-primary btn-sm"
                                                onclick="location.href='dailyList.board'">
                                            <i class="fas fa-list-ul"></i>
                                            <span>목록</span>
                                        </button>
                                        <button type="button" class="btn btn-info btn-sm"
                                                onclick="location.href='dailyReply.board?idx=${daily.idx}&cp=${cpage}&ps=${pagesize}'">
